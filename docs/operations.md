...
pm2 restart room-booking --update-env

# Stoppen / Starten
pm2 stop room-booking
pm2 start room-booking
...
PM2-Konfiguration: `/opt/room-booking/ecosystem.config.js`
...
|---|---|
| `/opt/room-booking/.env.local` | Alle Umgebungsvariablen (Secrets) |
...
```bash
pm2 logs room-booking --lines 50
# Häufige Ursachen:
